...
class FindViewController: ButtonBarPagerTabStripViewController {
    ...
    override func viewControllers(for pagerTabStripController: PagerTabStripViewController) -> [UIViewController] {
        let child_1 = FindEmailViewController(itemInfo: "아이디 찾기")
        let child_2 = FindPWViewController(itemInfo: "비밀번호 찾기")
